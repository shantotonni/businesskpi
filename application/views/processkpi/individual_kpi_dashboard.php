...
<div id="content">
    ...
    <div class="container-fluid" style="margin: 7px 7px">
        ...
        <form action="<?php echo base_url('processkpi/individualKpiDashboard'); ?>" method="post" style="margin-left: -8px">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="table" style="overflow-x: auto">
                        <table class="table table-bordered table-responsive table-hover table-striped">
                            ...
                            <tbody>
<!--                                --><?php
//                                    foreach ($individual_dashboard as $value){
//                                ?>
<!--                                <tr>-->
<!--                                    <td>--><?php //echo $value['ImpactArea'];?><!--</td>-->
<!--                                    <td>--><?php //echo $value['KPIName'];?><!--</td>-->
<!--                                    <td>--><?php //echo $value['UOM'];?><!--</td>-->
<!--                                    <td>--><?php //echo $value['GoodnessIndictaor'];?><!--</td>-->
<!--                                    <td>--><?php //echo $value['Weightage'];?><!--</td>-->
<!--                                    <td>--><?php //echo $value[202201];?><!--</td>-->
<!--                                </tr>-->
<!--                                --><?php
//                                    }
//                                ?>
                            ...
                            <tr>
                                ...
                                for ($j = 0; $j < count($index); $j++) {
                                    ...
                                    <!--Period 202201 start-->
                                            <?php
                                        if (($j == 6 || $j == 8 || $j == 10 || $j == 12 || $j == 14 || $j == 16 || $j == 18 || $j == 20 || $j == 22 || $j == 24 || $j == 26 || $j == 28) && $value < .80){
                                        ?>
                                           <td style="text-align: right;background: red;color: white"> <?php echo $value; ?> </td>

                                        <?php
                                    }elseif(($j == 6 || $j == 8 || $j == 10 || $j == 12 || $j == 14 || $j == 16 || $j == 18 || $j == 20 || $j == 22 || $j == 24 || $j == 26 || $j == 28) && $value >= .80 && $value < 1){
                                        ?>
                                            <td style="text-align: right;background: yellow"> <?php echo $value; ?> </td>
                                            <?php
                                        }elseif(($j == 6 || $j == 8 || $j == 10 || $j == 12 || $j == 14 || $j == 16 || $j == 18 || $j == 20 || $j == 22 || $j == 24 || $j == 26 || $j == 28) && $value >= 1){
                                            ?>
                                        <td style="text-align: right;background: green;color: white"> <?php echo $value; ?> </td>
                                        <?php
                                        }else{
                                        ?>
