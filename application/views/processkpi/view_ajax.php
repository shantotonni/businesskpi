        ...
        foreach($businesslist as $buss){   
            if(!empty($kpi)){
                foreach($kpi as $row){
					...
					//echo "componentcount" . $componentcount;
                            ...
                            <div class="col-md-4">
                                ...
                                <div  onclick="doLoadChartDetails(\''.$row['KPICode'].'\', \''.$buss['Business'].'\')" 
                                    ...
                                    <div style="width: 100%;">                            
                                        ...
                                        '.$row['ValueDriver'].' - '.$row['SubValueDriver'].' - '.$row['KPIName'].'&nbsp;<i class="fa fa-plus" style="font-size:16px; color:#888;"></i>
                                        </div>
                                    </div>                            
                                </div>
