            ...
            <div class="span12"> 
                ...
                <div class="widget-box">                    
                    <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                        ...
                        <a href="<?php echo base_url(); ?>kpi/subValueDriverAdd" id="btncurrent" class="btn btn-success" style=" float: right;">Add New</a>	
                    ...
                    <div class="widget-content nopadding">
                        <table class="table table-bordered data-table" id="report_data">
                            <thead>
                                <tr>
                                    <th>Sub Value Driver Code</th>
                                    <th>Sub Value Driver</th>
                                    <th>Value Driver</th>
                                    <th>Edit</th>
                                    <!--<th>Delete</th>-->
                                </tr>
                            ...
                            //print_r($rows);exit();
                                ...
                                ?>
                                <tr class="gradeX">
                                    <td style="text-align: center;"><?php echo $row['SubValueDriverCode']; ?></td>
                                    <td style="text-align: center;"><?php echo $row['SubValueDriver']; ?></td>
                                    <td style="text-align: center;"><?php echo $row['ValueDriver']; ?></td>
                                  
                                    <td style="text-align: center;"><a class="btn btn-primary" href="<?php echo base_url(); ?>kpi/subValueDriverEdit/<?php echo $row['SubValueDriverCode']; ?>">Edit</a></td>
