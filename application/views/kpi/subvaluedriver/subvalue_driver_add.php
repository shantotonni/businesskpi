            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        ?>                    
                        <form action="<?php echo base_url('kpi/subValueDriverAdd');?>" method="post" class="form-horizontal">                           
                            
                            <div class="control-group">
                                <label class="control-label">Sub Value Driver :</label>
                                <div class="controls">
                                    <input id="SubValueDriver" type="text" name="SubValueDriver" value="" class="span6" placeholder="Sub Value Driver" />
                                </div>
                            </div>
