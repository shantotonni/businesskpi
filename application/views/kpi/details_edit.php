                    ...
                    <div class="widget-content nopadding">
                        ...
                        <form action="<?php echo base_url('kpi/details_submit');?>" method="post" class="form-horizontal">                           
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select id='ValueDriverCode' name="ValueDriverCode" class="span6" readonly required>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select id='KPIMetricsCode' name="KPIMetricsCode" class="span6" readonly required>
                                            <?php 
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select id='Business' name="Business" class="span6" readonly required>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select id='CYEAR' name="CYEAR" class="span6" readonly required>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select name="CPERIOD" class="span6" readonly required>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="A" type="number" name="A" value="<?php echo isset($row->A) ? $row->A : '' ?>" class="span6" placeholder="A" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">ATXT :</label>
                                <div class="controls">
                                    <input id="ATXT" type="text" name="ATXT" value="<?php echo isset($row->ATXT) ? $row->ATXT : '' ?>" class="span6" placeholder="ATXT" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">B :</label>
                                <div class="controls">
                                    <input id="B" type="number" name="B" value="<?php echo isset($row->B) ? $row->B : '' ?>" class="span6" placeholder="B" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">BTXT :</label>
                                <div class="controls">
                                    <input id="BTXT" type="text" name="BTXT" value="<?php echo isset($row->BTXT) ? $row->BTXT : '' ?>" class="span6" placeholder="BTXT" />
                                </div>
                            </div>                            
                            <div class="control-group">
                                <label class="control-label">C :</label>
                                <div class="controls">
                                    <input id="C" type="number" name="C" value="<?php echo isset($row->C) ? $row->C : '' ?>" class="span6" placeholder="C" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">CTXT :</label>
                                <div class="controls">
                                    <input id="CTXT" type="text" name="CTXT" value="<?php echo isset($row->CTXT) ? $row->CTXT : '' ?>" class="span6" placeholder="CTXT" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">D :</label>
                                <div class="controls">
                                    <input id="D" type="number" name="D" value="<?php echo isset($row->D) ? $row->D : '' ?>" class="span6" placeholder="D" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">DTXT :</label>
                                <div class="controls">
                                    <input id="DTXT" type="text" name="DTXT" value="<?php echo isset($row->DTXT) ? $row->DTXT : '' ?>" class="span6" placeholder="DTXT" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">IndexValue :</label>
                                <div class="controls">
                                    <input id="IndexValue" type="number" name="IndexValue" value="<?php echo isset($row->IndexValue) ? $row->IndexValue : '' ?>" class="span6" placeholder="IndexValue" />
                                </div>
                            </div>
