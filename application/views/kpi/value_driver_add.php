            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        ?>                    
                        <form action="<?php echo base_url('kpi/valueDriverAdd');?>" method="post" class="form-horizontal">                           
                            
                            <div class="control-group">
                                <label class="control-label">Value Driver :</label>
                                <div class="controls">
                                    <input id="ValueDriver" type="text" name="ValueDriver" value="" class="span6" placeholder="Value Driver" />
                                </div>
                            </div>
