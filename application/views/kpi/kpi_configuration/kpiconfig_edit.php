            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        ?>                    
                        <form action="<?php echo base_url('kpi/kpiconfigEdit');?>" method="post" class="form-horizontal">                           
                           
                            <input type="hidden" name="KPICode" value="<?php echo isset($KpiConfig['KPICode']) ? $KpiConfig['KPICode'] : ''; ?>">
                                ...
                                <div class="controls">
                                    <select name="ValueDriverCode" id="ValueDriverCode" class="span6">
                                        ...
                                        <?php foreach($allValueDrivers as $v){ ?>
                                            <option value="<?php echo $v['ValueDriverCode']; ?>" <?php if($v['ValueDriverCode']==$KpiConfig['ValueDriverCode']) echo 'selected'; ?> ><?php echo $v['ValueDriver']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="controls">
                                    <select name="SubDriverCode" id="SubDriverCode" class="span6">
                                        ...
                                        <?php foreach($allSubValueDrivers as $v){ ?>
                                            <option value="<?php echo $v['SubValueDriverCode']; ?>" <?php if($v['SubValueDriverCode']==$KpiConfig['SubDriverCode']) echo 'selected'; ?> ><?php echo $v['SubValueDriver']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="KPIName" type="text" name="KPIName" value="<?php echo isset($KpiConfig['KPIName']) ? $KpiConfig['KPIName'] : ''; ?>" class="span6" placeholder="KPIName" />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea id="Description" rows="3" type="text" name="Description" value="" class="span6" placeholder="Description"><?php echo isset($KpiConfig['Description']) ? $KpiConfig['Description'] : ''; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="Formula" type="text" name="Formula" value="<?php echo isset($KpiConfig['Formula']) ? $KpiConfig['Formula'] : ''; ?>" class="span6" placeholder="Formula" />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="SOURCE" type="text" name="SOURCE" value="<?php echo isset($KpiConfig['SOURCE']) ? $KpiConfig['SOURCE'] : ''; ?>" class="span6" placeholder="SOURCE" />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="active" id="active" class="span6">
                                        <option value="">Select</option>
                                        <option value="Y" <?php if($KpiConfig['active']=='Y') echo 'selected'; ?> >Active</option>
                                        <option value="N" <?php if($KpiConfig['active']=='N') echo 'selected'; ?> >Inactive</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="Nature" id="Nature" class="span6">
                                        <option value="">Select</option>
                                        <option value="1" <?php if($KpiConfig['Nature']==1) echo 'selected'; ?> >Positive</option>
                                        <option value="-1" <?php if($KpiConfig['Nature']==-1) echo 'selected'; ?> >Negative</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="controls">
                                    <select name="Business" id="Business">
                                        ...
                                        foreach ($Business_rows as $business){
                                            ?>
                                            <option value="<?php echo $business['Business']?>" <?php if($KpiConfig['BusinessName']=== $business['Business']) echo 'selected'; ?>><?php echo $business['Business']?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="control-group">
                                <div class="">
                                    <table class="table table-bordered" id="tableinsert">
                                        ...
                                        <tbody id="tablebody">
                                            <?php foreach($KpiConfigDetails as $kd){ 
                                                $Title = $kd['Title'];
                                                $ValueType = $kd['ValueType'];
                                                $ChartType = $kd['ChartType'];
                                                ?>
                                                
                                            <tr id="rowToClone" class="processkpi">
                                                <td>
                                                    <?php echo $input1 = '<input type="text" class="span15 title" name="title[]" id="title" value="'.$Title.'" required style="min-width:400px;">'; ?>
                                                </td>
                                                <td>
                                                    <?php if($ValueType=="number"){ ?>
