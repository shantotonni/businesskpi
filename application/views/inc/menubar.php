...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
        ...
        <?php
        $usermenu = get_menu($this->session->userdata('userid'));
        if(isset($usermenu) && !empty($usermenu)){
            foreach($usermenu as $menu){
              // echo $menu['Page'];
        ?>

        <li class="<?php if(isset($page) && $page == $menu['Page']){echo 'active';}?>">
            <a href="<?php echo base_url($menu['Url']);?>"><i class="icon icon-home"></i><span><?=$menu['MenuName']?></span></a> 
        </li>
