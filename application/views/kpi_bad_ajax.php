                    ...
                    foreach($matricsfilter as $row1){ $count++; ?>
                        <div class="col-md-6" >
                            <div style="width: 95%; font-size:16px; background-color: #ffffc2; color: #444;  margin-top: 10px; margin-bottom: 10px; padding-left: 5px;">
                                <div style="width: 100%;">							
                                    <div style="width: 80%; text-align: left;" onclick="doLoadChart('<?php echo $row_bus['Business']; ?>','<?php echo $row['ValueDriver']; ?>','<?php echo str_replace("&","___", $row1['KPIMetrics']); ?>')" aria-hidden="true">
