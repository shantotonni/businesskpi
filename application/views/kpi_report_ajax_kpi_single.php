			...
			<div style="width: 98%; float: left; text-align: left; font-size:16px; background-color: #ccff90; 
                ...
                foreach($row_kpi_driven as $row){
                    ...
                    foreach($matricsfilter as $row1){ $count++; ?>
							<div onclick="doLoadChart('<?php echo $row_bus['Business']; ?>','<?php echo $row['ValueDriver']; ?>','<?php echo str_replace("&","___", $row1['KPIMetrics']); ?>')" style="cursor:grab; width: 95%; font-size:16px; background-color: #ffffc2; color: #444;  margin-top: 10px; margin-bottom: 10px; padding-left: 5px;">
								<div style="width: 100%;">							
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <table class="table table-bordered">
            <tbody>
                <tr>
                    <td style="width:300px; font-weight:600;">&nbsp;Total</td>
